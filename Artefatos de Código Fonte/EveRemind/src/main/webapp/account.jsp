                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon">
                                    <a ng-class="{'cursor-not-allowed': data.disabledResend, 'cursor-pointer': !data.disabledResend}" ng-click="resendToken()" bs-dynamic-tooltip="{title: 'account.notConfirmed', placement: 'down'}"><span ng-if="!$storage.sessionUser.emailVerified" class="glyphicon glyphicon-warning-sign span-warning"></span></a>
